...
SPEAKER_CAP = 6
CHECKPOINT_DIR = "checkpoints_for_6"


def parse_args():
    parser = argparse.ArgumentParser(description="Train AVSD model (speaker cap 6)")
    parser.add_argument(
        "--resume",
        type=str,
        default="",
        help="Checkpoint path to resume from (e.g., checkpoints_for_6/model_epoch_20.pth)",
    )
    parser.add_argument(
        "--epochs",
        type=int,
